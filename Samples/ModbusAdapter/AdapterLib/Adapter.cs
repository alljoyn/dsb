...
namespace AdapterLib
{
    public sealed class Adapter : IAdapter
    {
        ...
        // Modbus Gateway
        private ModbusGateway m_gateway = new ModbusGateway("169.254.21.200");  // The Designated IP address of the Modbus Gateway

        // My Modbus Specific Error Code
        private const uint ERROR_MODBUS_GATEWAY_DISCONNECT = 0xFF01;
        private const uint ERROR_MODBUS_INI_FAILED = 0xFF02;
